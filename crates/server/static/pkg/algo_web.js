...
export function clear_oc_level_lines() {
    wasm.clear_oc_level_lines();
}

export function clear_trade_lines() {
    wasm.clear_trade_lines();
}
 ...
 * @param {string} label
 */
export function open_option_chart_by_sid(sid, exchange_segment, instrument_type, label) {
    const ptr0 = passStringToWasm0(exchange_segment, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(instrument_type, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passStringToWasm0(label, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len2 = WASM_VECTOR_LEN;
    wasm.open_option_chart_by_sid(sid, ptr0, len0, ptr1, len1, ptr2, len2);
}
 ...
 * @param {number} sec_id
 * @param {string} exch
 * @param {string} inst_type
 * @param {string} name
 */
export function select_symbol(sec_id, exch, inst_type, name) {
    const ptr0 = passStringToWasm0(exch, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(inst_type, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
 ...
 * @param {string} json
 */
export function set_dir_markers(json) {
    const ptr0 = passStringToWasm0(json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.set_dir_markers(ptr0, len0);
}
 ...
 */
export function set_dir_series(json, color, line_width) {
    const ptr0 = passStringToWasm0(json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(color, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    wasm.set_dir_series(ptr0, len0, ptr1, len1, line_width);
}
 ...
 * @param {string} json
 */
export function set_oc_level_lines(json) {
    const ptr0 = passStringToWasm0(json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.set_oc_level_lines(ptr0, len0);
}
 ...
 * @param {boolean} on
 */
export function set_oi_trend_enabled(on) {
    wasm.set_oi_trend_enabled(on);
}
 ...
 * @param {string} json
 */
export function set_trade_lines(json) {
    const ptr0 = passStringToWasm0(json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.set_trade_lines(ptr0, len0);
}
 ...
 * @param {string} json
 */
export function update_oc_quotes(json) {
    const ptr0 = passStringToWasm0(json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.update_oc_quotes(ptr0, len0);
}
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_alert_b787658583d1e1d7: function() { return handleError(function (arg0, arg1, arg2) {
        ...
        __wbg_detail_84fdc765141875ba: function(arg0) {
        ...
        __wbg_set_globalAlpha_fead6b3865673822: function(arg0, arg1) {
        ...
        __wbg_set_placeholder_cb90d7858f78fdf3: function(arg0, arg1, arg2) {
            arg0.placeholder = getStringFromWasm0(arg1, arg2);
        },
        __wbg_set_scrollTop_b43e9ed358ec0b82: function(arg0, arg1) {
            arg0.scrollTop = arg1;
        },
        __wbg_set_step_abbce75c5770591e: function(arg0, arg1, arg2) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('algo_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
